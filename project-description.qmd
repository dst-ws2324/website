...
One team member should create a new **GitHub organization** (organizations are shared accounts where you can collaborate across many projects at once) and invite all other team members and me (my GitHub name is `kirenz`) to the organization. Also import this [Project template](https://github.com/dst-ws2324/project) to the organization.
