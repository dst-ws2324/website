...
| ---                   | ---           |  ---                  |
|[Topic ideas](@sec-topic-ideas)        | Fr., Oct 13   | references/           |
|[Project proposal](@sec-project-proposal)   | Fri, 27 Oct   | references/           |
|[Project draft](@sec-draft-analysis)     | Fri, Nov 17    | notebooks/            |
|[Peer review](@sec-peer-review-draft)  | Fri, Dec 1   | use [](issue-template)|
|[Report](@sec-report)             | Fr, Jan 19     | reports/              |
|[Slides](@sec-slides-video)       | Fri, Feb 10   | reports/              |
|[GitHub repo](@sec-github-repo)      | Fri, Jan 26   | "Repo in final state" |
|[Comments](@sec-comments)          | We, Feb 15    | "Comment in Moodle"   |
|[Presentation](@sec-presentation  )        | Mo, Jan 29    | "Present"     |
|[Survey](@sec-team-eval  )        | Fri, Jan 2    | "Fill out survey"     |
...
The goal of the final project is for you to analyze a data set of your own choosing and effectively communicate the results (using the concepts and technology we covered in this course). The data set may already exist or you may collect your own data.

Choose the data based on your group's interests or work you all have done in other courses or research projects. The goal of this project is for you to demonstrate proficiency in the techniques we have covered in this class (and beyond, if you like) and apply them to a data set to analyze and communicate it in a meaningful way.

All analyses must be done in Python, and all components of the project **must be reproducible** (with the exception of the final presentation) placed inside the repos of your GitHub Organization (organizations are shared accounts where you can collaborate across many projects at once).
...
2. Create a [GitHub Project](https://kirenz.github.io/lab-toolkit/github.html#github-projects) in your organization
3. Import this [Project template](https://github.com/dst-ws2324/project) to your organization.
...
- *Conclusion and recommended action*: This section includes initial interpretations and conclusions drawn from the data.
...
All written work (with exception of presentation slides) should be reproducible, and the GitHub repo should be neatly organized. Use GitHub Project to organize your team work.
...
You will present your work in the last week of the semester.
