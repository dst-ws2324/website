...
1. **Data Story as Presentation and Report (using Altair and Quarto)**
...
2. Create a [GitHub Project](https://kirenz.github.io/lab-toolkit/github.html#github-projects) in your organization and use it to organize your work9
3. Import this [Project template](https://github.com/dst-ws2324/project) to your organization (click on `use this template`).
4. Import this [Documentation template](https://github.com/kirenz/documentation-template) to your organization (click on `use this template`)
