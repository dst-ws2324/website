...
-   For the *projects*, collaboration within teams is not only allowed, but expected (use GitHub Projects). Communication between teams at a high level is also allowed however you may not share code or components of the project across teams.
