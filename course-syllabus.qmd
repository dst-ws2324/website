...
- use Python and other tools to analyze, prepare and visualize data 
...
You will be assigned to a team at the beginning of the semester. All team members are expected to contribute equally to the completion of the project and you will be asked to evaluate your team members throughout the semester. Failure to adequately contribute to the project will result in a penalty to your mark relative to the team's overall mark.

You are expected to make use of GitHub as the central collaborative platform. [Commits](https://github.com/git-guides/git-commit) to this repository will be used as a metric (one of several) of each team member's relative contribution for each project. You also need to use GitHub Projects to organize your work.
...
Learn fundamental data skills at your own pace. Find out the basics for developing, analyzing, and making decisions with data. The course series [Data Literacy for All](https://elearning-samples.tableau.com/page/data-literacy) is provided by Tableau and covers key topics, including understanding data types, basic statistics concepts, and interpreting visualizations. 
...
In homeworks (HW), you will apply what you've learned during lectures to complete data analysis and visualization tasks. You may discuss homework assignments with other students; however, homework should be completed and **submitted individually**.


### Project {#sec-project}

The purpose of the [project](project-description.qmd) is to apply what you've learned throughout the semester. The project will be completed in **teams**.


| Assessment Component                          | Points Allocated |
|-----------------------------------------------|------------------|
| **Data Story as Presentation and Report**     |                  |
| - Relevance                                   | 5 points         |
| - Visualization & Design                      | 10 points        |
| - Storytelling & Narrative                    | 10 points        |
| - Alignment with Knaflic's Principles         | 10 points         |
| **Total for Data Story as Report**            | **35 points**    |
|                                               |                  |
| **Interactive Dashboard (Streamlit & Altair)**|                  |
| - User Experience                             | 10 points        |
| - Interactivity                               | 10 points        |
| - Visualization & Design                      | 10 points        |
| - Data Relevance & Insightfulness             | 5 points         |
| **Total for Interactive Dashboard**           | **35 points**    |
|                                               |                  |
| **Documentation of Creation Process**         |                  |
| - Clarity & Structure                         | 8 points         |
| - Technical Proficiency                       | 8 points         |
| - Process Explanation                         | 8 points         |
| - Accessibility & Design                      | 3 points         |
| - Alignment with Course Literature            | 3 points         |
| **Total for Documentation**                   | **30 points**    |
|                                               |                  |
...
| Category              | Points      |
|-----------------------|-----------------|
| Data Literacy Course  | 20             |
| Homework              | 20             |
| Project               | 100             |


The final grade will be determined based on the following percentage thresholds:
...
-   For the *project*, collaboration within teams is not only allowed, but expected (use GitHub Projects). Communication between teams at a high level is also allowed however you may not share code or components of the project across teams.
...
-   *Project* may be submitted up to 2 days late. There will be a 25% deduction for each 24-hour period the project task is late.
